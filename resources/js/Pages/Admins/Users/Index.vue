        ...
        <div class="modal-content">
            ...
            <div class="modal-body overflow-hidden">
                <div class="h4 d-flex flex-column">
                    ...
                    <span class="mt-2">Preview E-mail: <span>{{form.email}}</span></span>
                </div>
                    ...
                    <form @submit.prevent="checkMode">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="E-mail address" v-model="form.email" :class="{'is-invalid': form.errors.email}"
                                 autocomplete="off">
                            </div>
                            <div class="invalid-feedback mb-3" :class="{'d-block': form.errors.email}">{{form.errors.email}}</div>
                            ...
                            <div class="invalid-feedback mb-3" :class="{'d-block': form.errors.roles}">{{form.errors.roles}}</div>
                        </div>
